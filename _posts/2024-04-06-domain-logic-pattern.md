...
2. [도메인 모델 패턴](#3-도메인-모델-패턴)
   ...
   1. [도메인 모델 장점](#31-도메인-모델-장점)
   2. [도메인 모델 단점](#32-도메인-모델-단점)
   3. [도메인 모델 사용 시점](#33-도메인-모델-사용-예시)
   4. [빈약한 도메인 모델과 풍부한 도메인 모델](#34-빈약한-도메인-모델과-풍부한-도메인-모델)
      1. [빈약한 도메인 모델 패턴](#341-빈약한-도메인-모델)
      2. [풍부한 도메인 모델 패턴](#342-풍부한-도메인-모델)
